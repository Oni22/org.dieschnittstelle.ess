...
public class StockSystemClient implements StockSystemRemote {
	...
	public StockSystemClient() throws Exception {
		...
		this.ejbProxy = EJBProxyFactory.getInstance().getProxy(null,"ejb:org.dieschnittstelle.ess.ejb/org.dieschnittstelle.ess.ejb.ejbmodule.erp/StockSystemSingleton!org.dieschnittstelle.ess.ejb.ejbmodule.erp.StockSystemRemote");
	}
