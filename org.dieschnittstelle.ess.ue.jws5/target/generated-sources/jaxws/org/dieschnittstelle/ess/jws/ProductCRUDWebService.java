 ...
 * 2019-05-21T13:51:03.068+02:00
 * Generated source version: 3.3.1
 *
 */
@WebServiceClient(name = "ProductCRUDWebService",
                  wsdlLocation = "http://localhost:8080/org.dieschnittstelle.ess.ue.jws4/ProductCRUDWebService?wsdl",
                  targetNamespace = "http://dieschnittstelle.org/ess/jws")
public class ProductCRUDWebService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://dieschnittstelle.org/ess/jws", "ProductCRUDWebService");
    public final static QName ProductCRUDPort = new QName("http://dieschnittstelle.org/ess/jws", "ProductCRUDPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/org.dieschnittstelle.ess.ue.jws4/ProductCRUDWebService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ProductCRUDWebService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/org.dieschnittstelle.ess.ue.jws4/ProductCRUDWebService?wsdl");
        }
        WSDL_LOCATION = url;
    }
